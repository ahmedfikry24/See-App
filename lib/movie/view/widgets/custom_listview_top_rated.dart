...
class CustomListViewTopRated extends StatelessWidget {
  const CustomListViewTopRated({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<GetTopRatedCubit, GetTopRatedState>(
        listener: (context, state) {},
        builder: (context, state) {
          GetTopRatedCubit cubit = GetTopRatedCubit.get(context);
          return HandlingView(
